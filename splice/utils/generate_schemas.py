...
def generate_schema(
    ...
    *,
    ...
    :param exclude: conjunto de campos a serem excluídos (ex: {"id"} para criação)
    :param optional: se True, torna os campos (exceto os excluídos ou id) opcionais (para update)
