...
from splice.interface.routers.product_router import router as product_router
from splice.interface.routers.subproduct_router import (
    router as subproduct_router,
)
